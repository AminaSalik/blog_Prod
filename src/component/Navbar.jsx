...
<a href="/register" className="inline-flex justify-center hover:text-gray-900 items-center py-2 px-4 sm:ms-2 text-sm font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
  Register
</a>
